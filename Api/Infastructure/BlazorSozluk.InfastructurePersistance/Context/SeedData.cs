...
namespace BlazorSozluk.InfastructurePersistance.Context
{
    public class SeedData
    {
        ...
        {
            var result = new Faker<Users>("tr").RuleFor(i => i.Id, i => Guid.NewGuid())
                ...
                .RuleFor(i => i.EnailConfirmed, i => i.PickRandom(true, false))
                .Generate(500);
            return result;
        ...
        public async Task SeedAsync(IConfiguration configuration)
        {
            ...
            dbContextBuilder.UseSqlServer(configuration["BlazorSozlukConnectionStrings"]);
            ...
            var comments = new Faker<EntryComment>("tr")
               ...
               .RuleFor(i => i.CreateDate, i => i.Date.Between(DateTime.Now.AddDays(-100), DateTime.Now))
               .RuleFor(i => i.Content, i => i.Lorem.Paragraph(2))
               .RuleFor(i => i.EntryById, i => i.PickRandom(guids))
               .RuleFor(i => i.CreatedById, i => i.PickRandom(userIds))
               .Generate(1000);
